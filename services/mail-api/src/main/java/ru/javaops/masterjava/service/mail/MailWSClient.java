...
public class MailWSClient {
    ...
    private static final String HOST_NAME = "mail";
    private static final WsClient<MailService> WS_CLIENT;
    private static final SoapLoggingHandlers.ClientHandler LOGGING_HANDLER = new SoapLoggingHandlers.ClientHandler();
    ...
    static {
        ...
        WS_CLIENT.init(HOST_NAME, "/mail/mailService?wsdl");
    }
    ...
    private static MailService getPort() {
        ...
        WsClient.setAuth(port, HOST_NAME);
